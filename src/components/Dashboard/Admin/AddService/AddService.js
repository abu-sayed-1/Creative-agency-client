    ...
    return (
        ...
        <div className="row m-0 p-0 ">
            ...
            <div className="background_color brand_content col-md-10">
             <div style={{ borderRadius: '20px',backgroundColor: 'white'}}   className="row mx-0 p-3 m-5 mr-0">
             ...
             <form onSubmit={handleSubmit(onSubmit)}>
                   <h6>Service Title</h6>
                    ...
                    <h6>Description</h6>
                    <div className="form-group">
                        <textarea name="description" ref={register({ required: true, minLength: 10 })} className="form-control" id="" cols="20" rows="5" placeholder=" Enter Designation"></textarea>
                        {errors.description && <span className="text-danger">Designation is required and minimum Ten character ^</span>}
                  </div>
                  <button style={{    float: 'right', marginRight: '4rem'}}  type="submit" className="admin_btn"> Submit </button>
             </form>
             </div>
